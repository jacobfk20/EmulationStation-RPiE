...
GuiMenu::GuiWifiWizard(Window* window) : GuiComponent(window), mMenu(window, "CONNECTION WIZARD"), mVersion(window)
{
    // MAIN MENU
    ...
    addEntry("FINISH AND CREATE NEW CONNECTION", 0x777777FF, true,
    [this] {
    ...
    addEntry("WIFI SETTINGS", 0x777777FF, false,
    [this] {
    ...
    [this] {
        ...
        row.makeAcceptInputHandler([window] {
            ...
            [] {
                ...
                {
                    system("python /home/pi/360rf/shutdown.py");
                    LOG(LogWarning) << "Attempting to shut off 360 controllers";
