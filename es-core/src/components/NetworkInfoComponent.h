...
public:
	...
	void setWanInterface(std::string wanInterface) { mWifiDevice = wanInterface; }
	void setLanInterface(std::string lanInterface) { mLanDevice = lanInterface; }
	std::string getWanInterface() { return mWifiDevice; }
	std::string getLanInterface() { return mLanDevice; }

	bool getWanState() { return mWifiState; }
	bool getLanState() { return mLanState; }
